...
const setVisibility = (visibility) =>
  (getElementById("idr_idcard").style.visibility = visibility);
...
const closeFunction = () => {
  getElementById("idr_idcard").classList.remove(
    "animate__animated",
    "animate__fadeInLeft",
    "animate__faster"
  );
...
const openIdCard = (playerData) => {
  ...
  getElementById("idr_idcard").style.backgroundColor = license.background;
  getElementById("idr_idcard").classList.add(
    "animate__animated",
    "animate__fadeInLeft",
    "animate__faster"
  );
